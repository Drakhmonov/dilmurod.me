...
const experience = [
  ...
  },
  {
    ...
    link: 'https://www.uzbekculture.co.uk/',
            ...
            >
              <div className="pt-1">
                ...
                <a
                  ...
                  className="font-display font-bold text-muted text-sm hover:text-coral transition-colors"
                >
                  {e.company}
                </a>
              </div>
